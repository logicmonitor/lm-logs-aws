...
func TestCloudWatchEventsBedrockModel(t *testing.T) {
	...
	var metadataMap = map[string]interface{}{"_integration": "aws", "_type": "bedrock.amazonaws.com", "logGroup": "/aws/bedrock/modelinvocate", "logStream": "aws/bedrock/modelinvocations", "_lm.tenantId": "123456"}
	expectedLMEvent := model.LogInput{
