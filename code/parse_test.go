...
func TestParseELBlogs(t *testing.T) {
	...
	fileName := "AWSLogs/664833354492/elasticloadbalancing/us-west-1/2020/06/02/664833354492_elasticloadbalancing_us-west-1_test_20200511T0925Z_34.242.46.46_4jtxqo72.txt"
	...
	expectedLMEvent := ingest.Log{
		Message:    message,
		Timestamp:  time,
		ResourceID: map[string]string{"system.aws.arn": "arn:aws:elasticloadbalancing:us-west-1:664833354492:loadbalancer/test"},
	}
